...
def test_render_manufacturer_page_authenticated(client, seeded_data):
    # Given
    _login(client)

    # When
    response = client.get("/admin/manufacturer/list")
...
def test_render_manufacturer_page_unauthenticated_redirects_to_login(client, seeded_data):
    # Given

    # When
    response = client.get("/admin/manufacturer/list", follow_redirects=False)
...
def test_render_manufacturer_details_authenticated(client, seeded_data):
    # Given
    _login(client)

    # When
    response = client.get(f"/admin/manufacturer/{seeded_data.id}/details")
