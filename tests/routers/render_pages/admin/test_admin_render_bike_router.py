...
def test_render_bikes_page_authenticated(client, seeded_data):
    # Given
    _login(client)

    # When
    response = client.get("/admin/bikes/list")
...
def test_render_bikes_page_unauthenticated_redirects_to_login(client, seeded_data):
    # Given

    # When
    response = client.get("/admin/bikes/list", follow_redirects=False)
...
def test_render_bike_details_authenticated(client, seeded_data):
    # Given
    _login(client)

    # When
    response = client.get(f"/admin/bikes/{seeded_data.id}/details")
...
def test_render_create_bike_page_authenticated(client, seeded_data):
    # Given
    _login(client)

    # When
    response = client.get("/admin/bikes/create")
