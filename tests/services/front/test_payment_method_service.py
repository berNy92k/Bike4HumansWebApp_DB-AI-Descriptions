...
def test_get_method_by_id(db_session, seeded_payment_methods):
    ...
    # When
    result = service.get_method_by_id(method_id)
...
def test_get_method_by_id_not_found(db_session, seeded_payment_methods):
    # Given
    service = PaymentMethodService(db_session)

    # When
    result = service.get_method_by_id(999999)
